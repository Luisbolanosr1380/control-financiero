...
import {
  CUSTOMERS, LINES, INVOICES, LINE_STATS, AGING,
  MONTHLY, AI_INSIGHTS, SUMMARY,
} from '@/lib/mock-data';
import type { LineStats, AgingEntry, MonthlyEntry, AIInsight, Customer } from '@/lib/types';
...
function Kpi({ label, value, prev, percent, positiveIsGood, neutral, warnAlways }: KpiProps) {
...
function MiniAgingBar({ customer }: { customer: Customer }) {
